...
document.getElementById('tab_1').onclick = function (e) {
...
document.getElementById('tab_2').onclick = function (e) {
    mymap.eachLayer(function (layer) {
       mymap.removeLayer(layer);
    });
    var urlFilesrv_world = 'http://filesrv/geodbse/giswebservicese/service.php?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=world&STYLE=default&TILEMATRIXSET=GoogleMapsCompatible&TILEMATRIX={z}&TILEROW={x}&TILECOL={y}&FORMAT=image/png8';
...
//var watercolor1 = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
//    maxZoom: 18,
//    attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
//        '<a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, ' +
//        'Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
