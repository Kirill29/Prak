...
namespace Geoportal.Controllers
{
	...
	public class FileController : Controller
	{
		...
		private static readonly List<FilesCmr> filesCmrs = new List<FilesCmr>();
		...
		public FileController(IHostingEnvironment appEnviroment, iContext context, ISave_Files save_Files,
			IConfiguration configuration, ILogger_custom logger)
		{
			_logger = logger;
