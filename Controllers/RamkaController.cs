...
namespace Geoportal.Controllers
{
    ...
    public class RamkaController : Controller
    {
       ...
       //вью для добавления WKT или SHP рамки
        ...
        [Authorize]
        public IActionResult Add_Draw(string geometry_multiPolgon, string cmr_name_value_draw,string geometry_multiLineString,string geometry_multiPoint)
        {
            ...
            Shape shape_draw = creator.Create(cmr_name_value_draw,  geometry_multiPolgon, geometry_multiLineString,  geometry_multiPoint, conn);
